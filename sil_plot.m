function [ ] = sil_plot( eval_obj_names, names )
...
ylabel('value of the silhouette clustering criterion','fontsize',14)
title('Silhouette optimal clustering evaluation for k-means','fontsize',14)
